import { ATTACK_SORT, CLEAR_POKEMONS, CREATE_POKEMON, GET_ALL_POKEMONS, GET_TYPES, NAME_SORT, ORIGIN_FILTER, SEARCH_POKEMONS, SEARCH_POKEMON_DETAIL, TYPE_FILTER } from "../actions";
